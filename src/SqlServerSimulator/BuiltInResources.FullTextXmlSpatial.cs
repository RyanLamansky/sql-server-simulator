...
internal static partial class BuiltInResources
{
    ...
    private static void RegisterFullTextXmlSpatial(Dictionary<string, CatalogView> views)
    {
        ...
        [
            ...
            new("change_tracking_state", CharSqlType.Get(1, Collation.Baseline, Coercibility.Implicit), 1, true),
        ...
        [
            ...
            new("property_name", NVarcharSqlType.Get(256, Collation.Get("SQL_Latin1_General_CP437_CS_AS"), Coercibility.Implicit), 256, false),
        ...
        [
            ...
            new("secondary_type", CharSqlType.Get(1, Collation.Baseline, Coercibility.Implicit), 1, true),
        ...
        [
            ...
            new("tessellation_scheme", nvarchar60Catalog, 60, true),
            new("has_filter", SqlType.Bit, null, false),
        ...
        [
            ...
            new("level_1_grid_desc", nvarchar60Catalog, 60, true),
            new("level_2_grid", SqlType.SmallInt, null, true),
            new("level_2_grid_desc", nvarchar60Catalog, 60, true),
            new("level_3_grid", SqlType.SmallInt, null, true),
            new("level_3_grid_desc", nvarchar60Catalog, 60, true),
            new("level_4_grid", SqlType.SmallInt, null, true),
            new("level_4_grid_desc", nvarchar60Catalog, 60, true),
        ...
        [
            ...
            new("authority_name", NVarcharSqlType.Get(128, Collation.Get("Latin1_General_CI_AI"), Coercibility.Implicit), 128, true),
            new("authorized_spatial_reference_id", SqlType.Int32, null, true),
            new("well_known_text", NVarcharSqlType.Get(4000, Collation.Get("Latin1_General_CI_AI"), Coercibility.Implicit), 4000, true),
            new("unit_of_measure", NVarcharSqlType.Get(128, Collation.Get("Latin1_General_CI_AI"), Coercibility.Implicit), 128, true),
