...
internal static partial class BuiltInResources
{
    ...
    private static void RegisterExpressionDependencies(Dictionary<string, CatalogView> views) =>
        ...
        [
            ...
            new("referencing_class", SqlType.TinyInt, null, true),
            new("referencing_class_desc", nvarchar60Catalog, 60, true),
            new("is_schema_bound_reference", SqlType.Bit, null, false),
            new("referenced_class", SqlType.TinyInt, null, true),
            new("referenced_class_desc", nvarchar60Catalog, 60, true),
            new("referenced_server_name", nvarchar128Baseline, 128, true),
            new("referenced_database_name", nvarchar128Baseline, 128, true),
            new("referenced_schema_name", nvarchar128Baseline, 128, true),
            new("referenced_entity_name", nvarchar128Baseline, 128, true),
