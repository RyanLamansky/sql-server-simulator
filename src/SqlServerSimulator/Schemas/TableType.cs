...
internal sealed class TableType(
    ...
    DateTime createDate,
    HeapColumn[] columns,
    (KeyConstraintKind Kind, string? Name, int[] FullOrdinals, bool? Clustered)[] pendingKeys,
    ...
    : SchemaObject(name, typeTableObjectId, schema.SchemaId, createDate)
{
    ...
    /// </summary>
    public readonly (KeyConstraintKind Kind, string? Name, int[] FullOrdinals, bool? Clustered)[] PendingKeys = pendingKeys;
