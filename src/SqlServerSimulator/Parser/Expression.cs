...
internal abstract class Expression : ExpressionNode
{
    ...
    private static Expression ParseLeadingAtom(ParserContext context) => context.Token switch
    {
        ...
        DoubleAtPrefixedString doubleAtPrefixedString => doubleAtPrefixedString.Parse() switch
        {
            ...
            AtAtKeyword.TranCount => new TranCountExpression(),
            AtAtKeyword.RowCount => new RowCountExpression(),
            AtAtKeyword.LockTimeout => new LockTimeoutExpression(),
            AtAtKeyword.TextSize => new TextSizeExpression(),
            AtAtKeyword.SpId => new SpidExpression(),
            ...
            AtAtKeyword.DateFirst => new DateFirstExpression(),
            AtAtKeyword.Language => new LanguageExpression(),
            AtAtKeyword.LangId => new LangIdExpression(),
