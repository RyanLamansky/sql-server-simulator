...
internal sealed class Atn2 : Expression
{
    ...
    {
        _ = AssignmentRules.ArgumentType(this.first, SqlType.Float, batch, resolveColumnType);
        _ = AssignmentRules.ArgumentType(this.second, SqlType.Float, batch, resolveColumnType);
