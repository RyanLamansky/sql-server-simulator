...
internal sealed class Subtract : TwoSidedExpression
{
    ...
    protected override Storage.SqlValue Run(Storage.SqlValue left, Storage.SqlValue right) => AdditiveArithmetic(left, right, '-', "subtract", static (a, b) => checked(a - b));
    ...
    internal static Storage.SqlValue NegateViaZero(Storage.SqlValue operand) =>
        AdditiveArithmetic(Storage.SqlValue.FromInt32(0), operand, '-', "subtract", static (a, b) => checked(a - b));
