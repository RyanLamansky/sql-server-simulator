...
- **`DROP SCHEMA`**, **`ALTER SCHEMA … TRANSFER`**, **`sys.schemas`** / **`INFORMATION_SCHEMA.SCHEMATA`** — deferred. CREATE SCHEMA + schema-qualified resolution ships; lifecycle and metadata views don't yet.
