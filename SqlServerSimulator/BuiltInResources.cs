...
internal static class BuiltInResources
{
    ...
    private static Dictionary<string, HeapTable> BuildSystemHeapTables()
    {
        ...
        [
            new("name", SqlType.SystemName, false),
            new("xtype", SqlType.TinyInt, false),
            new("status", SqlType.TinyInt, true),
            new("xusertype", SqlType.SmallInt, true),
            new("length", SqlType.SmallInt, false),
            new("xprec", SqlType.TinyInt, false),
            new("xscale", SqlType.TinyInt, false),
            new("tdefault", SqlType.Int32, false),
            new("domain", SqlType.Int32, false),
            new("uid", SqlType.SmallInt, true),
            new("reserved", SqlType.SmallInt, true),
            new("collationid", SqlType.Int32, true),
            new("usertype", SqlType.SmallInt, true),
            new("variable", SqlType.Bit, false),
            new("allownulls", SqlType.Bit, true),
            new("type", SqlType.TinyInt, false),
            new("printfmt", SqlType.Varchar, true),
            new("prec", SqlType.SmallInt, true),
            new("scale", SqlType.TinyInt, true),
            new("collation", SqlType.SystemName, true),
        ];
