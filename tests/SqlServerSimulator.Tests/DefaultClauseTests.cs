...
public sealed class DefaultClauseTests
{
    ...
    // sys.default_constraints.definition holds the default expression in SQL
    // Server's canonical form (probed 2026-09-26 against SQL Server 2025).
    [TestMethod]
    ...
    public void DefaultConstraint_Definition_HoldsTheCanonicalForm(string column, string expected)
    ...
    [TestMethod]
    public void DefaultConstraint_AlterAddDefault_Definition_HoldsTheCanonicalForm()
